...
export default function AboutPage() {
    return (
        <div id="aboutPage">
            ...
            <p className="about_text">To assuage her daughter’s anxiety, Mamma takes Cleo on “raids” to demonstrate how their powers can be used for more than entertainment.  On a night illuminated by a long sunset, Cleo discovers her mother is a feared vigilante, often tasked with defending their way of life from their less-evolved, human ancestors.  A cohort of villains from Mamma's past are thwarted by the mother daughter team, and although this first mission doesn’t go as planned, Mamma becomes even more of a hero to her children.</p>
